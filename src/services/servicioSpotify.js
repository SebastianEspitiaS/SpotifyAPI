...
export async function pedirCanciones(){
    ...
    const urlCanciones = `https://api.spotify.com/v1/artists/${}/top-tracks?market=us`
...
export async function pedirDatosArtistas(idArtist) {
   
    const url = "https://accounts.spotify.com/api/token";
    const urlDatos = `https://api.spotify.com/v1/artists/${idArtist}`
    const grant_type = "client_credentials";
...
export async function pedirNombreArtista() {
    ...
    const url = "https://accounts.spotify.com/api/token";
    const urlDatos = 'https://api.spotify.com/v1/artists?ids=2DaxqgrOhkeH0fpeiQq2f4,11wRdbnoYqRddKBrpHt4Ue,22bE4uQ6baNwSHPVcDxLCe,3WrFJ7ztbogyGnTHbHJFl2,7bu3H8JO7d0UbMoVzbo70s,762310PdDnwsDxAQxzQkfX'
    const grant_type = "client_credentials";
    const client_id = "179a0c8c73e2420abb7327af96814fd6";
    const client_secret = "9a1383b9d3834042a5dc466ab5362f82";
